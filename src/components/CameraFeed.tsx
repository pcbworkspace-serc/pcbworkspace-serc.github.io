    ...
    async function start() {
      try {
        if (!navigator.mediaDevices?.getUserMedia) {
          if (!cancelled) setError("Camera not available (page must be on localhost or https)");
          return;
        }
