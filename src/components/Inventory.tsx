...
function ResistorIcon() {
  return (
    <svg viewBox="0 0 32 12" className="w-8 h-3 text-slate-700" stroke="currentColor" strokeWidth="1.4" fill="none" strokeLinejoin="round" strokeLinecap="round">
...
function CapacitorIcon() {
  return (
    <svg viewBox="0 0 24 14" className="w-6 h-4 text-slate-700" stroke="currentColor" strokeWidth="1.6" fill="none" strokeLinecap="round">
...
function DiodeIcon() {
  return (
    <svg viewBox="0 0 26 12" className="w-7 h-3 text-slate-700" stroke="currentColor" strokeWidth="1.4" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
function LEDIcon() {
  return (
    <svg viewBox="0 0 28 16" className="w-7 h-4 text-slate-700" stroke="currentColor" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
function TransistorIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-6 h-6 text-slate-700" stroke="currentColor" strokeWidth="1.4" fill="none" strokeLinecap="round" strokeLinejoin="round">
